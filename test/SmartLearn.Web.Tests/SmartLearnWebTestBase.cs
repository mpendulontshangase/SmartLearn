...
{
    public abstract class SmartLearnWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SmartLearnWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SmartLearnWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<SmartLearnDbContext> action)
        {
            using (var context = IocManager.Resolve<SmartLearnDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<SmartLearnDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<SmartLearnDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SmartLearnDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SmartLearnDbContext, Task<T>> func)
        {
            T result;
