        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Time_sent = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_Sl.Persons_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Sl.Persons",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Messages_Sl.Persons_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sl.Records", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Sl.Records_Sl.Persons_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Sl.Persons",
                        principalColumn: "Id");
                });
