...
{
    public partial class smartlearndb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sl.Persons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Sl.Persons_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeworkFileId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HomeworkRecords_Sl.Persons_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Sl.Persons",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HomeworkRecords_StoredFiles_HomeworkFileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeworkRecords_HomeworkFileId",
                table: "HomeworkRecords",
                column: "HomeworkFileId");

            migrationBuilder.CreateIndex(
                name: "IX_HomeworkRecords_TeacherId",
                table: "HomeworkRecords",
                column: "TeacherId");
