...
namespace SmartLearn.Migrations
{
    ...
    [Migration("20230605191418_111222333332")]
    partial class _111222333332
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartLearn.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartLearn.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SmartLearn.Domain.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartLearn.Domain.Teacher", b =>
                {
                    b.HasBaseType("SmartLearn.Domain.Person");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("SmartLearn.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("SmartLearn.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("SmartLearn.Authorization.Roles.Role", b =>
                {
                    b.HasOne("SmartLearn.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("SmartLearn.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("SmartLearn.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartLearn.Domain.Person", b =>
                {
                    b.HasOne("SmartLearn.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
